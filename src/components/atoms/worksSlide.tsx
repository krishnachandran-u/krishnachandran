...
const WorksSlide = () => {
    return (
        <div className = "size-full flex flex-col gap-[24px] text-white group hover:cursor-pointer">
            ...
            <div className = "text-[18px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim.</div>
            <div className = "flex justify-center items-center max-w-[300px] max-h-[300px] size-full overflow-hidden">
