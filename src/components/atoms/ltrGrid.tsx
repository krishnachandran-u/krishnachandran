...
const LtrGrid = ({ltrs, color} : {ltrs : string[], color: string}) => {
    ...
    return (
        <div 
            className = {`grid grid-rows-2 grid-cols-2 gap-[2px] sm:border-[2px] border-[1px] border-[${color}] ${font.className} text-[${color}] text-[12px] sm:text-[16px] sm:w-[35px] sm:h-[35px] w-[28px] h-[28px]`}
            style = {{
                color: color,
                borderColor: color,
            }}
